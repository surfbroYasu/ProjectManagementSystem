package com.example.projectmanagement.modules.designs.app.controllers.module;
...
import com.example.projectmanagement.modules.designs.app.datastructures.form.ModuleDefinitionForm;
import com.example.projectmanagement.modules.designs.app.service.application.ModulePageContext;
import com.example.projectmanagement.modules.designs.app.service.repository.ModuleRepostitoryService;
...
public class ModuleController {
	...
	@Autowired
	private ModulePageContext contextService;
	...
	public String renderModuleList(@PathVariable Integer projectId, Model model) {
		...
		contextService.setupModuleListPage(model, projectId, pageTitleMK);
	...
	public String moduleCUD(@PathVariable Integer projectId, @PathVariable String action,
		...
		if (result.hasErrors()) {
			contextService.setupModuleListPage(model, projectId, "error");
			return TEMPLATE_ROOT + "/module_list";
		}
